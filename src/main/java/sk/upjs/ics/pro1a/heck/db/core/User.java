...
public class User implements Serializable {
    ...
    public User(String emailUser, String loginUser, String passwordUser, String salt, String firstNameUser,
            String lastNameUser, String phoneUser, String postalCodeUser, String cityUser, String addressUser) {
        this.emailUser = emailUser;
        this.loginUser = loginUser;
        this.passwordUser = passwordUser;
        this.saltUser = salt;
    ...
    public User(String emailUser, String loginUser, String passwordUser, String salt, String firstNameUser,
            String lastNameUser, String phoneUser,String postalCodeUser, String cityUser, String addressUser,
            Timestamp registrationTime, Boolean activeUser, Boolean isAdmin) {
        this.emailUser = emailUser;
        this.loginUser = loginUser;
        this.passwordUser = passwordUser;
        this.saltUser = salt;
